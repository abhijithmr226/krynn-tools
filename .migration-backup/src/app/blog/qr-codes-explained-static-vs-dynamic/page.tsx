...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/blog/qr-codes-explained-static-vs-dynamic" },
  openGraph: {
    title: "QR Codes Explained: Static vs Dynamic",
    description: "Understand the difference between static and dynamic QR codes, when to use each, and how to generate them for free.",
    type: "article",
    url: "https://www.krynntools.online/blog/qr-codes-explained-static-vs-dynamic",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.krynntools.online/blog/qr-codes-explained-static-vs-dynamic" },
          }),
        }}
      />
      </article>
