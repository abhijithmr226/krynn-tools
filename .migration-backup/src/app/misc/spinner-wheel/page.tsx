...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/misc/spinner-wheel" },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://www.krynntools.online/misc/spinner-wheel",
    ...
    images: [{ url: "https://www.krynntools.online/logo.png", width: 1200, height: 630, alt: "Spinner Wheel – Krynn Tools" }],
  },
  twitter: {
