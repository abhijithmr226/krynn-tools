...
export const metadata: Metadata = {
  ...
  keywords: ["qr code for business","generate qr code","business qr code","qr code marketing"],
  alternates: { canonical: "https://www.krynntools.online/blog/how-to-generate-qr-codes-for-business" },
  openGraph: {
    title: "How to Generate QR Codes for Business",
    description: "Create QR codes for menus, events, payments, and marketing. Step-by-step guide for business owners.",
    type: "article",
    url: "https://www.krynntools.online/blog/how-to-generate-qr-codes-for-business",
