...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/blog/how-to-convert-units-online" },
  openGraph: {
    title: "How to Convert Units Online (Length, Weight, Temperature)",
    description: "Convert between metric and imperial units for length, weight, temperature, volume, and area. Free online unit converter.",
    type: "article",
    url: "https://www.krynntools.online/blog/how-to-convert-units-online",
    images: [{ url: "https://www.krynntools.online/images/blog/unit-converter.svg", width: 1200, height: 630 }],
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.krynntools.online/blog/how-to-convert-units-online" },
          }),
        }}
      />
      </article>
