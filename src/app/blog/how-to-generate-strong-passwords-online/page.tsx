...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://krynntools.online/blog/how-to-generate-strong-passwords-online" },
  openGraph: {
    title: "How to Generate a Strong Password Online",
    description: "Learn how to generate strong, random passwords online. Free tool creates secure passwords with customizable length and character rules.",
    type: "article",
    url: "https://krynntools.online/blog/how-to-generate-strong-passwords-online",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: { "@type": "WebPage", "@id": "https://krynntools.online/blog/how-to-generate-strong-passwords-online" },
          }),
        }}
      />
      </article>
