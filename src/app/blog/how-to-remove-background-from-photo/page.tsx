...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/blog/how-to-remove-background-from-photo" },
  openGraph: {
    title: "How to Remove a Background From a Photo in 10 Seconds",
    description: "Remove photo backgrounds instantly with a free browser-based tool. No software install, no upload required.",
    type: "article",
    url: "https://www.krynntools.online/blog/how-to-remove-background-from-photo",
    images: [{ url: "https://www.krynntools.online/images/blog/remove-background.svg", width: 1200, height: 630 }],
