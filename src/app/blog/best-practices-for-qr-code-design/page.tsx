...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://krynntools.online/blog/best-practices-for-qr-code-design" },
  openGraph: {
    title: "Best Practices for QR Code Design",
    description: "Learn QR code design best practices for print and digital. Ensure scannability with size, contrast, error correction, and branding tips.",
    type: "article",
    url: "https://krynntools.online/blog/best-practices-for-qr-code-design",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            mainEntityOfPage: { "@type": "WebPage", "@id": "https://krynntools.online/blog/best-practices-for-qr-code-design" },
          }),
        }}
      />
      </article>
