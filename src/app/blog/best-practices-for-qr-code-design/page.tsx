...
export const metadata: Metadata = {
  ...
  keywords: ["qr code design","qr code best practices","qr code size","qr code scannability"],
  alternates: { canonical: "https://www.krynntools.online/blog/best-practices-for-qr-code-design" },
  openGraph: {
    title: "Best Practices for QR Code Design",
    description: "Learn QR code design best practices for print and digital. Ensure scannability with size, contrast, error correction, and branding tips.",
    type: "article",
    url: "https://www.krynntools.online/blog/best-practices-for-qr-code-design",
