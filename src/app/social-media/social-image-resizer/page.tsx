...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/social-media/social-image-resizer" },
  openGraph: {
    type: "website", locale: "en_US", url: "https://www.krynntools.online/social-media/social-image-resizer",
    ...
    images: [{ url: "https://www.krynntools.online/logo.png", width: 1200, height: 630, alt: "Social Media Image Resizer – Krynn Tools" }],
  },
  twitter: { card: "summary_large_image", title: "Social Media Image Resizer", description: "Resize images for all social media platforms.", images: ["https://www.krynntools.online/logo.png"] },
};
