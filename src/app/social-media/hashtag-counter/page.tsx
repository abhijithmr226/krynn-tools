...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/social-media/hashtag-counter" },
  openGraph: {
    type: "website", locale: "en_US", url: "https://www.krynntools.online/social-media/hashtag-counter",
    ...
    images: [{ url: "https://www.krynntools.online/logo.png", width: 1200, height: 630, alt: "Hashtag Counter – Krynn Tools" }],
  },
  twitter: { card: "summary_large_image", title: "Hashtag Counter & Generator", description: "Count hashtags and generate hashtag sets.", images: ["https://www.krynntools.online/logo.png"] },
};
