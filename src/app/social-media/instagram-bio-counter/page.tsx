...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.krynntools.online/social-media/instagram-bio-counter" },
  openGraph: {
    type: "website", locale: "en_US", url: "https://www.krynntools.online/social-media/instagram-bio-counter",
    ...
    images: [{ url: "https://www.krynntools.online/logo.png", width: 1200, height: 630, alt: "Instagram Bio Counter – Krynn Tools" }],
  },
  twitter: { card: "summary_large_image", title: "Instagram Bio & Caption Character Counter", description: "Count characters for Instagram bios and captions.", images: ["https://www.krynntools.online/logo.png"] },
};
