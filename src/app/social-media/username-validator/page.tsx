...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://krynntools.online/social-media/username-validator" },
  openGraph: {
    type: "website", locale: "en_US", url: "https://krynntools.online/social-media/username-validator",
    ...
    images: [{ url: "https://krynntools.online/logo.png", width: 1200, height: 630, alt: "Username Validator – Krynn Tools" }],
  },
  twitter: { card: "summary_large_image", title: "Instagram Username Validator", description: "Check if a username meets Instagram format requirements.", images: ["https://krynntools.online/logo.png"] },
};
