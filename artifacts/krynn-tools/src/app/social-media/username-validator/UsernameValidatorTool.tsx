  ...
  return (
    <ToolLayout
      ...
      faq={[
        ...
        { question: "What characters are allowed in TikTok usernames?", answer: "TikTok usernames can contain letters, numbers, periods, underscores, and dashes. They must be 2–24 characters long. Unlike Instagram, TikTok allows dashes and has no period restrictions." },
        { question: "What characters are allowed in Twitter / X usernames?", answer: "Twitter / X usernames (handles) can only contain letters, numbers, and underscores. No periods or special characters are allowed. They must be 1–15 characters long." },
        ...
        { question: "Is this tool affiliated with Instagram, TikTok, or Twitter?", answer: "No. This is an independent tool. We validate against publicly known username rules, but always check the platform's official guidelines for the latest requirements." },
      ]}
