...
export const categories: Category[] = [
  { name: "PDF Tools", slug: "pdf", description: "Compress, merge, split, convert, crop, watermark, and edit PDF files online for free.", icon: "FileText", color: "#EF4444" },
  ...
  { name: "AI Writing Tools", slug: "ai-writing", description: "AI-powered writing assistants for essays, blogs, social posts, and more.", icon: "Pen", color: "#8B5CF6" },
];
...
export const tools: Tool[] = [
  ...
  { slug: "rearrange-pdf", name: "Rearrange PDF Pages", description: "Drag and drop to reorder PDF pages in any sequence you want.", category: "PDF Tools", categorySlug: "pdf", icon: "ArrowsClockwise", keywords: ["rearrange pdf pages", "reorder pdf pages", "sort pdf pages", "change page order pdf"] },
  { slug: "crop-pdf", name: "Crop PDF", description: "Crop PDF pages by setting custom margin values to trim edges.", category: "PDF Tools", categorySlug: "pdf", icon: "Crop", keywords: ["crop pdf", "trim pdf margins", "cut pdf edges", "crop pdf pages"] },
  { slug: "add-page-numbers", name: "Add Page Numbers", description: "Add page numbers to every page of your PDF with custom position and style.", category: "PDF Tools", categorySlug: "pdf", icon: "ListOrdered", keywords: ["add page numbers to pdf", "number pdf pages", "page numbering pdf", "insert page numbers"] },
  { slug: "add-watermark", name: "Add Watermark to PDF", description: "Overlay text watermarks on every page of your PDF with custom font, size, and opacity.", category: "PDF Tools", categorySlug: "pdf", icon: "Droplets", keywords: ["add watermark to pdf", "pdf watermark tool", "text watermark pdf", "stamp pdf"] },
  { slug: "repair-pdf", name: "Repair PDF", description: "Fix corrupted or damaged PDF files by re-encoding them with pdf-lib.", category: "PDF Tools", categorySlug: "pdf", icon: "Wrench", keywords: ["repair pdf", "fix corrupted pdf", "broken pdf repair", "restore pdf"] },
  { slug: "sign-pdf", name: "Sign PDF", description: "Add a signature image overlay to any page of your PDF document.", category: "PDF Tools", categorySlug: "pdf", icon: "Pen", keywords: ["sign pdf online", "add signature to pdf", "digital signature pdf", "electronically sign pdf"] },
  { slug: "html-to-pdf", name: "HTML to PDF", description: "Convert HTML code into a downloadable PDF document instantly.", category: "PDF Tools", categorySlug: "pdf", icon: "Code", keywords: ["html to pdf converter", "convert html to pdf", "html to pdf online", "webpage to pdf"] },
  ...
  { slug: "gif-to-jpg", name: "GIF to JPG", description: "Convert animated or static GIF images to high-quality JPG format instantly.", category: "Image Tools", categorySlug: "image", icon: "Image", keywords: ["gif to jpg converter", "convert gif to jpeg online", "gif to jpg free"] },
  { slug: "heic-converter", name: "HEIC Converter", description: "Convert Apple HEIC photos to JPG or PNG format for universal compatibility.", category: "Image Tools", categorySlug: "image", icon: "FileImage", keywords: ["heic converter", "heic to jpg", "convert heic online", "apple photo converter"], popular: true },
  { slug: "tiff-converter", name: "TIFF Converter", description: "Convert TIFF images to JPG, PNG, or WebP format with quality controls.", category: "Image Tools", categorySlug: "image", icon: "Image", keywords: ["tiff converter", "tiff to jpg", "convert tiff online"] },
  { slug: "psd-converter", name: "PSD Converter", description: "Convert Photoshop PSD files to PNG, JPG, or WebP without Photoshop installed.", category: "Image Tools", categorySlug: "image", icon: "FileImage", keywords: ["psd converter", "psd to png", "convert psd online", "photoshop file converter"] },
  { slug: "raw-converter", name: "RAW Converter", description: "Convert camera RAW files (CR2, NEF, ARW, DNG) to standard JPG or PNG images.", category: "Image Tools", categorySlug: "image", icon: "Camera", keywords: ["raw converter", "cr2 to jpg", "nef converter", "raw to jpg online"] },
  { slug: "html-to-image", name: "HTML to Image", description: "Convert HTML code or snippets into downloadable PNG or JPG images.", category: "Image Tools", categorySlug: "image", icon: "Code", keywords: ["html to image converter", "html to png", "screenshot html code", "html to screenshot"] },
  { slug: "meme-generator", name: "Meme Generator", description: "Create custom memes by adding top and bottom text to any image.", category: "Image Tools", categorySlug: "image", icon: "Smiley", keywords: ["meme generator online", "create meme free", "meme maker", "add text to meme"], popular: true },
  ...
  // AI Writing Tools (12)
  { slug: "essay-writer", name: "AI Essay Writer", description: "Generate well-structured essays on any topic with AI-powered writing assistance.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "Pen", keywords: ["ai essay writer", "essay generator", "write essay online", "ai writing tool"], popular: true },
  { slug: "paragraph-writer", name: "AI Paragraph Writer", description: "Generate coherent paragraphs on any subject with AI writing assistance.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "AlignLeft", keywords: ["ai paragraph writer", "paragraph generator", "write paragraph online"] },
  { slug: "story-generator", name: "AI Story Generator", description: "Create engaging short stories and narratives with AI-powered creativity.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "BookOpen", keywords: ["ai story generator", "short story creator", "story writer online"] },
  { slug: "blog-generator", name: "AI Blog Generator", description: "Generate complete blog posts on any topic with proper structure and SEO-friendly content.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "Article", keywords: ["ai blog generator", "blog post writer", "blog content creator"], popular: true },
  { slug: "blog-outline", name: "AI Blog Outline", description: "Generate structured blog outlines with headings, subheadings, and key points.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "ListDashes", keywords: ["blog outline generator", "ai outline tool", "blog structure creator"] },
  { slug: "faq-generator", name: "AI FAQ Generator", description: "Automatically generate relevant FAQ sections from any content or topic.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "Question", keywords: ["faq generator", "ai faq creator", "generate faq online"] },
  { slug: "grammar-fixer", name: "AI Grammar Fixer", description: "Fix grammar, spelling, and punctuation errors in your text instantly.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "CheckCircle", keywords: ["grammar checker", "fix grammar online", "ai grammar tool"], popular: true },
  { slug: "sentence-rewriter", name: "AI Sentence Rewriter", description: "Rewrite sentences to improve clarity, tone, or style while preserving meaning.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "ArrowsClockwise", keywords: ["sentence rewriter", "paraphrase tool", "rewrite text online", "ai paraphraser"] },
  { slug: "content-improver", name: "AI Content Improver", description: "Enhance and polish your writing for better readability and engagement.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "Sparkle", keywords: ["content improver", "ai text enhancer", "improve writing online"] },
  { slug: "business-name-generator", name: "AI Business Name Generator", description: "Generate creative and memorable business name ideas for your startup.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "Lightbulb", keywords: ["business name generator", "startup name ideas", "ai business naming"], popular: true },
  { slug: "linkedin-post-generator", name: "AI LinkedIn Post Generator", description: "Create professional LinkedIn posts that drive engagement and grow your network.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "ShareNetwork", keywords: ["linkedin post generator", "linkedin content creator", "ai linkedin writer"] },
  { slug: "instagram-caption-generator", name: "AI Instagram Caption Generator", description: "Generate creative Instagram captions with hashtags and emoji suggestions.", category: "AI Writing Tools", categorySlug: "ai-writing", icon: "Camera", keywords: ["instagram caption generator", "ig caption writer", "social media caption creator"] },
];
